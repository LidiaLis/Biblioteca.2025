...
public class FrmDevolucao extends javax.swing.JFrame {
    ...
    DevolucaoDAO devolucaoDAO = DAOFactory.criarDevolucaoDAO();
...
private void atualizarTabela(String campo, Object valor) {
    ...
    DevolucaoDAOJDBC dao = new DevolucaoDAOJDBC();
    List<Devolucao> devolucoes = new ArrayList<>();

    // Verifica qual campo está sendo filtrado e executa a busca com o id correspondente
    if ("leitor".equals(campo)) {
        devolucoes = dao.listarPorCampo("id_usuario", (Integer) valor);  // Assumindo que "valor" é o id do usuário
    } else if ("titulo".equals(campo)) {
        devolucoes = dao.listarPorCampo("id_livro", (Integer) valor);  // Assumindo que "valor" é o id do livro
    } else if ("data_emprestimo".equals(campo)) {
        devolucoes = dao.listarPorCampo("data_emprestimo", valor); // Filtro por data
    } else if ("data_devolucao".equals(campo)) {
        devolucoes = dao.listarPorCampo("data_devolucao", valor); // Filtro por data
    }

    // Verifica se algum resultado foi encontrado com o filtro
    if (devolucoes.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Nenhuma devolução encontrada com o filtro aplicado.");
    }
    ...
    for (Devolucao devolucao : devolucoes) {
        model.addRow(new Object[]{
            ...
            devolucao.getId_livro().getTitulo(),             // Titulo
            devolucao.getId_usuario().getNome(),             // Leitor
            devolucao.getId_emprestimo().getData_emprestimo(), // Data Emprestimo
            devolucao.getData_devolucao()                    // Data Devolução
        });
    }
}
    ...
    List<Devolucao> devolucaos = dao.listar(); 

    for (Devolucao devolucao : devolucaos) {
        model.addRow(new Object[]{
    devolucao.getId_devolucao(),
    devolucao.getId_livro().getTitulo(),             // Titulo
    devolucao.getId_usuario().getNome(),             // Leitor
    ...
    private void initComponents() {
        ...
        tblAcervo.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Devolução", "Titulo", "Leitor", "Data Emprestimo", "Data Devolução"
            }
        ) {
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addGap(34, 34, 34)
                    .addComponent(cbTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(41, 41, 41))
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addComponent(cbDataEmprestimo, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGap(37, 37, 37)
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(cbDataDevolucao, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    jPanel1Layout.setHorizontalGroup(
        ...
        .addGroup(jPanel1Layout.createSequentialGroup()
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGap(70, 70, 70)
                    .addComponent(ScrollLivro, javax.swing.GroupLayout.PREFERRED_SIZE, 673, javax.swing.GroupLayout.PREFERRED_SIZE)))
            .addGap(0, 0, Short.MAX_VALUE))
    );
    ...
    int idDevolucao = (int) tblAcervo.getValueAt(linhaSelecionada, 0);
    DialogDevolucao dialog = new DialogDevolucao(this, true, idDevolucao);
    dialog.setVisible(true);

    if (dialog.salvouAlteracao()) {
        atualizarTabela();
    ...
    DialogDevolucao dialog = new DialogDevolucao(this, true, null);
    ...
    if (confirmacao == JOptionPane.YES_OPTION) {
        ...
        try {
            ...
            int sucesso = dao.apagar(idDevolucao);

            if (sucesso > 0) {
                ((DefaultTableModel) tblAcervo.getModel()).removeRow(linhaSelecionada);
                JOptionPane.showMessageDialog(this, "Devolucao apagado com sucesso!");
            } else {
                JOptionPane.showMessageDialog(this, "Erro ao apagar o devolucao!", "Erro", JOptionPane.ERROR_MESSAGE);
            }

        } catch (SQLException | ClassNotFoundException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Erro ao tentar apagar o devolucao: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
    }    
    ...
    for (Devolucao d : dao.listar()) {
        String titulo = d.getId_livro().getTitulo();
    ...
    DefaultComboBoxModel<Usuario> modeloUsuario = new DefaultComboBoxModel<>();
    for (Devolucao d : dao.listar()) {
        Usuario usuario = d.getId_usuario();
        boolean jaExiste = false;
        for (int i = 0; i < modeloUsuario.getSize(); i++) {
            if (modeloUsuario.getElementAt(i).getId_usuario() == usuario.getId_usuario()) {
                jaExiste = true;
                break;
            }
        }
    ...
    cbUsuario.setModel(modeloUsuario);
    ...
    for (Devolucao d : dao.listar()) {
        Date dataEmprestimo = d.getId_emprestimo().getData_emprestimo();
        if (dataEmprestimo != null) {
            String dataEmp = sdfEmp.format(dataEmprestimo);
    ...
    for (Devolucao d : dao.listar()) {
        Date dataDevolucao = d.getData_devolucao();
        if (dataDevolucao != null) {
            String dataDev = sdfDev.format(dataDevolucao);
    ...
    private void btnLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimparActionPerformed
        ...
        cbDataDevolucao.setSelectedIndex(0);
...
private void preencherTabela() {
    ...
    DevolucaoDAOJDBC dao = new DevolucaoDAOJDBC();  // Instancia o DAO de devolução

    try {
        // Lista todas as devoluções diretamente do banco
        List<Devolucao> devolucoes = dao.listar(); 

        for (Devolucao devolucao : devolucoes) {
            model.addRow(new Object[]{
                devolucao.getId_devolucao(),                   // ID da devolução
                devolucao.getId_livro().getTitulo(),           // Título do livro
                devolucao.getId_usuario().getNome(),           // Nome do usuário (Leitor)
                devolucao.getId_emprestimo().getData_emprestimo(), // Data do empréstimo
                devolucao.getData_devolucao()                  // Data da devolução
            });
        }

    } catch (Exception e) {
        e.printStackTrace();
        JOptionPane.showMessageDialog(this, "Erro ao preencher a tabela: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
    }
}
